...
= How to display Clients Name ? =
As Previous answer post title will display as clients name on slider

= How to display Cients comments ? =
As Previous answer by adding a post on "Testimonial" post body will display a clients feedback as comments on sliders


== Screenshots ==
1. Kento Testimonial Slider Testimonial in Sidebar.
2. Kento Testimonial Slider Post.
3. Kento Testimonial Slider Admin.
